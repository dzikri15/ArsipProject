...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mt-6 flex gap-2">
            ...
            <a href="<?php echo e(route('dokumen.preview', $dokumen['id'])); ?>" target="_blank" class="px-4 py-2 bg-gray-700 text-white rounded">Preview</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mt-6">
        ...
        <div style="position:relative; padding-top:56.25%; background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px; overflow:hidden;">
            <iframe src="<?php echo e(route('dokumen.preview', $dokumen['id'])); ?>" style="position:absolute; inset:0; width:100%; height:100%; border:none;" title="Preview Dokumen"></iframe>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\arsip-ukri\resources\views/pages/dokumen-show.blade.php ENDPATH**/ ?>