...
<div class="panel">
  <div class="panel-body">
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
      <div>
        <img src="<?php echo e(Illuminate\Support\Facades\Storage::url($foto->file_path)); ?>" alt="<?php echo e($foto->judul); ?>" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
      </div>
      <div>
        ...
        <div style="display: flex; gap: 8px; margin-top: 20px;">
          <a href="<?php echo e(route('foto.edit', $foto->id)); ?>" class="btn btn-danger">Edit</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\arsip-ukri\resources\views/pages/foto-show.blade.php ENDPATH**/ ?>