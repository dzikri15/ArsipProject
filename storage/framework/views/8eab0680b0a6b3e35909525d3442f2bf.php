      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="<?php echo e($linkUrl); ?>" target="_blank" style="color:var(--accent);font-size:12px;"><?php echo e($l->url); ?></a></td>
            ...
            <td>
              <div class="td-actions">
                <button class="btn btn-sm btn-outline" onclick="window.open('<?php echo e($linkUrl); ?>', '_blank')" title="Buka Link">🔗</button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\arsip-ukri\resources\views/pages/link.blade.php ENDPATH**/ ?>