  ...
  <div class="login-card">
    ...
    <form method="POST" action="<?php echo e(route('login.post')); ?>">
      ...
      <div class="form-group">
        ...
        <input class="form-input" type="email" name="email" placeholder="email@ukri.ac.id" value="<?php echo e(old('email')); ?>" required>
      </div>
      <div class="form-group">
...
<?php /**PATH C:\laragon\www\arsip-ukri\arsip-ukri\resources\views/pages/login.blade.php ENDPATH**/ ?>