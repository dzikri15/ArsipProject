    ...
    <div class="table-wrap">
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td><b><?php echo e($u->nama); ?></b></td>
            <td><?php echo e($u->email); ?></td>
            <td><span class="badge <?php echo e($u->role === 'admin' ? 'badge-info' : 'badge-default'); ?>"><?php echo e($u->role); ?></span></td>
            <td><?php echo e($u->nim); ?></td>
            <td><span class="badge <?php echo e($u->status ? 'badge-success' : 'badge-warning'); ?>"><?php echo e($u->status ? 'Aktif' : 'Nonaktif'); ?></span></td>
            <td><?php echo e($u->created_at->format('d M Y H:i')); ?></td>
            <td>
              <div class="td-actions">
                <button class="btn btn-sm btn-warn" onclick="editItem(<?php echo e($u->id); ?>, 'users')" title="Edit">✏️</button>
                <?php if($u->role !== 'admin'): ?>
                  <button class="btn btn-sm btn-danger" onclick="deleteItem(<?php echo e($u->id); ?>, 'users', '<?php echo e($u->nama); ?>')" title="Hapus">🗑</button>
                <?php endif; ?>
              </div>
            </td>
          </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\arsip-ukri\arsip-ukri\resources\views/pages/users.blade.php ENDPATH**/ ?>